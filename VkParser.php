...
class VkParser extends VkParserApi
{
        ...
        if($albums)
        {
            ...
            if($this->goodCategoryes)
            {
                ...
                $tmpAlbums = [];
                 ...
                 if(count($this->vkAlbums) == 0) $this->vkAlbums = $albums;
                //print_r($this->vkAlbums);
            }
    ...
    { 
        ...
        /*
            ...
            echo 'Update goods = '.count($updateGoods).'; ';
            $createGoods = $this->getGoodsCreate($this->goods);
            echo 'Create goods = '.count($createGoods).'; ';
            return $result;
        */    
        //--------
        $updateGoods = $this->getGoodsUpdate($this->goods, $this->description, $this->utm, $this->existGoodsItemids);
                if(count($updateGoods) > 0)
                {
                    ...
                    {
                        //if($good['good_id'] != 'hctshorts0218') continue;
                        $result = [];
    ...
    public function deleteGoodsByCategory($goods)
    {
    ...
    public function sendGoodByCategory()
    {
